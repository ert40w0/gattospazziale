...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $descrizione = isset($_POST['descrizione']) ? $conn->real_escape_string($_POST['descrizione']) : NULL;
    $immagine = isset($_POST['immagine']) ? $conn->real_escape_string($_POST['immagine']) : NULL;
    ...
    if (!empty($immagine) && !filter_var($immagine, FILTER_VALIDATE_URL)) {
        ...
        if ($conn->query($sql)) {
            ...
            $error = "Errore nell'aggiornamento: " . $conn->error;
        }
    }
}
